    ...
    <div class="layer-foreground container" id="addCard" style="width: 500px; height: 400px; border: solid">
        ...
        <form id="addform" class="form-horizontal hidden-form" role="form" action="addcontent.html" method="post">
            ...
            <%
                ...
                {
            %>
                <div style="background-color: #e6e6e6" id="tagcard-<%= tag.getId() %>" onclick="chooseTag(this.id)"><%= tag.getTagName() %></div>
            <%
                }
            %>
...
<div class="layer-foreground container" id="addCard" style="width: 500px; height: 400px; border: solid">
    <h3>修改内容</h3>
    <hr color="#A0A0A0"/>
    <form id="updateform" class="form-horizontal hidden-form" role="form" action="addcontent.html" method="post">
        <div class="form-group">
            <label class="control-label" for="url">网址</label>
            <input class="form-control" id="url2" name="url" type="text" readonly="readonly">
        </div>
        <div class="form-group">
            <label class="control-label" for="tags">标签（以半角逗号分割）</label>
            <input class="form-control" id="updatetags" name="tags" type="text" readonly="readonly">
        </div>
        <div style="overflow: auto" id="tagcards" class="" >
            <%
                for ()
            %>
        </div>
